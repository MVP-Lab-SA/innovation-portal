...
// Ordered to follow the innovation funnel: source → business challenges →
// campaigns → ideas/sandbox → pilots/evaluations → initiatives, then the
// supporting domains. `id` is a stable identifier, not a position.
export const DASHBOARDS: NavItem[] = [
  ...
  { id: 'DASH-20', title: 'التحديات وفرص الأعمال', description: 'التحديات الاستراتيجية ومصدر الحملات', href: '/dashboards/business-challenges', icon: Puzzle, color: 'text-purple-700' },
