...
export const ENTITY_CONFIGS: Record<string, EntityConfig> = {
  ...
  initiatives: {
    ...
    formFields: [
      ...
      { key: 'department', label: 'الإدارة المعنية', lookupCategory: 'Departments' },
      ...
      { key: 'documentationUrl', label: 'التوثيق', type: 'url' },
      { key: 'update1', label: 'التحديث 1', type: 'textarea', cols: 2 },
      { key: 'update2', label: 'التحديث 2', type: 'textarea', cols: 2 },
      { key: 'update3', label: 'التحديث 3', type: 'textarea', cols: 2 },
      { key: 'notes', label: 'ملاحظات', type: 'textarea', cols: 2 },
    ],
  },
  ...
  ideas: {
    ...
    formFields: [
      ...
      { key: 'businessChallengeId', label: 'تحدي الأعمال المرتبط', type: 'reference', referenceEntity: 'business-challenges' },
      { key: 'relatedChallengeId', label: 'الحملة المرتبطة', type: 'reference', referenceEntity: 'campaigns' },
  ...
  'sandbox-applications': {
    ...
    formFields: [
      ...
      { key: 'commercialRegistration', label: 'رقم السجل التجاري' },
      { key: 'city', label: 'موقع الشركة / المدينة' },
      ...
      { key: 'contactPhone', label: 'رقم التواصل', type: 'tel' },
      { key: 'requestNature', label: 'طبيعة الطلب' },
      { key: 'solutionDescription', label: 'وصف مختصر للحل', type: 'textarea', cols: 2 },
      { key: 'problemStatement', label: 'المشكلة التي يعالجها الحل', type: 'textarea', cols: 2 },
      { key: 'solutionDomain', label: 'القطاع المستهدف / مجال الحل', lookupCategory: 'SolutionDomain' },
      { key: 'otherSector', label: 'قطاع مستهدف آخر' },
      ...
      { key: 'isRegulated', label: 'حاصل على ترخيص أو خاضع للرقابة؟', type: 'select', options: ['نعم', 'لا'] },
      { key: 'hasConflictingRegulations', label: 'تنظيمات حالية تتعارض مع الابتكار؟', type: 'select', options: ['نعم', 'لا'] },
      { key: 'conflictingRegulationDetails', label: 'اللائحة التنظيمية والجهة المختصة', type: 'textarea', cols: 2 },
      { key: 'overlapsGovEntities', label: 'تداخل مع جهات حكومية أو أنظمة قائمة؟', type: 'select', options: ['نعم', 'لا'] },
      { key: 'needsData', label: 'هل يحتاج الحل إلى بيانات؟', type: 'select', options: ['نعم', 'لا'] },
      { key: 'needsIntegration', label: 'هل يحتاج تكامل تقني مع أنظمة الوزارة؟', type: 'select', options: ['نعم', 'لا'] },
      { key: 'needsRegulatoryException', label: 'هل يتطلب استثناء تنظيمي؟', type: 'select', options: ['نعم', 'لا'] },
      { key: 'businessPlanFile', label: 'خطة العمل / العرض التقديمي', type: 'file', cols: 2 },
      { key: 'scalingStrategy', label: 'استراتيجية العمل وخطة التمويل للتوسع', type: 'textarea', cols: 2 },
      { key: 'expectedOutcomes', label: 'النتائج المتوقعة من التجربة', type: 'textarea', cols: 2 },
      { key: 'successKpis', label: 'مؤشرات الأداء الرئيسية', type: 'textarea', cols: 2 },
      { key: 'postTrialLicensesNeeded', label: 'التراخيص المطلوبة بعد التجربة', type: 'textarea', cols: 2 },
      { key: 'proposedTrialLocation', label: 'موقع التجربة المقترح' },
      { key: 'useCases', label: 'حالات الاستخدام المقترح اختبارها', type: 'textarea', cols: 2 },
      { key: 'targetCustomers', label: 'نوع العملاء وآلية الحصول عليهم', type: 'textarea', cols: 2 },
      { key: 'proposedTimeline', label: 'الجدول الزمني والمعالم الرئيسية', type: 'textarea', cols: 2 },
      { key: 'identifiedRisks', label: 'المخاطر والإجراءات الاستباقية', type: 'textarea', cols: 2 },
      { key: 'expectedImpact', label: 'الأثر المتوقع', type: 'textarea', cols: 2 },
      ...
      { key: 'submissionDate', label: 'تاريخ التقديم', type: 'date' },
      { key: 'reviewer', label: 'المراجع' },
      { key: 'update1', label: 'تحديث 1', type: 'textarea', cols: 2 },
      { key: 'update2', label: 'تحديث 2', type: 'textarea', cols: 2 },
      { key: 'campaignId', label: 'الحملة المرتبطة', type: 'reference', referenceEntity: 'campaigns' },
      { key: 'businessChallengeId', label: 'تحدي الأعمال', type: 'reference', referenceEntity: 'business-challenges' },
      { key: 'pilotId', label: 'التجربة الناتجة', type: 'reference', referenceEntity: 'pilots' },
      { key: 'ideaId', label: 'الفكرة المرتبطة', type: 'reference', referenceEntity: 'ideas' },
      { key: 'partnerId', label: 'الجهة المسجّلة كشريك', type: 'reference', referenceEntity: 'partners' },
      { key: 'notes', label: 'ملاحظات', type: 'textarea', cols: 2 },
    ],
  },
  ...
  'business-challenges': {
    ...
    formFields: [
      ...
      { key: 'parentId', label: 'التحدي الرئيسي', type: 'reference', referenceEntity: 'business-challenges' },
      { key: 'strategicSourceId', label: 'مصدر التحدي', type: 'reference', referenceEntity: 'strategic-sources' },
      ...
      { key: 'track', label: 'مسار التحدي', type: 'select', options: ['بحث وتطوير', 'ابتكار'] },
      { key: 'hackathonReadiness', label: 'جاهزية الهاكاثون', type: 'select', options: ['مناسب', 'مناسب بشروط', 'غير مناسب'] },
  ...
  experts: {
    ...
    formFields: [
      ...
      { key: 'category', label: 'التصنيف', lookupCategory: 'ExpertCategory' },
      { key: 'specialization', label: 'التخصص' },
      { key: 'email', label: 'البريد الإلكتروني', type: 'email' },
      { key: 'phone', label: 'الجوال', type: 'tel' },
      { key: 'organization', label: 'الجهة' },
      { key: 'agency', label: 'الوكالة' },
      { key: 'department', label: 'الإدارة' },
      { key: 'jobTitle', label: 'المسمى الوظيفي' },
      { key: 'yearsExperience', label: 'سنوات الخبرة', type: 'number' },
      { key: 'country', label: 'الدولة', lookupCategory: 'Country' },
      { key: 'city', label: 'المدينة' },
      ...
      { key: 'bio', label: 'الخبرة العملية / نبذة', type: 'textarea', cols: 2 },
    ],
  },
  ...
  'expert-opinions': {
    ...
    description: 'تقييم آراء ومرئيات الخبراء وفق معايير التقييم',
    listColumns: [
      { key: 'code', label: 'المعرّف', type: 'badge' },
      { key: 'subject', label: 'الموضوع' },
      { key: 'finalScore', label: 'التقييم النهائي' },
      { key: 'visualizationGrade', label: 'تصنيف المرئيات', type: 'badge' },
      { key: 'recommendation', label: 'التوصية' },
    ],
    formFields: [
      { key: 'expertId', label: 'الخبير', required: true, type: 'reference', referenceEntity: 'experts' },
      { key: 'businessChallengeId', label: 'تحدي الأعمال', type: 'reference', referenceEntity: 'business-challenges' },
      { key: 'subject', label: 'موضوع الرأي', cols: 2 },
      { key: 'summary', label: 'ملخص الرأي / المرئيات', type: 'textarea', cols: 2 },
      { key: 'relevanceScore', label: 'ملاءمة التخصص (1-5)', type: 'number' },
      { key: 'depthScore', label: 'عمق التحليل (1-5)', type: 'number' },
      { key: 'applicabilityScore', label: 'قابلية التطبيق (1-5)', type: 'number' },
      { key: 'neutralityScore', label: 'الحياد المهني (1-5)', type: 'number' },
      { key: 'consistencyScore', label: 'الاتساق العام (1-5)', type: 'number' },
      { key: 'finalScore', label: 'التقييم النهائي (مرجّح)', type: 'number' },
      { key: 'visualizationGrade', label: 'تصنيف المرئيات', type: 'select', options: ['مرئيات عالية الجودة', 'مرئيات جيدة', 'مرئيات مقبولة', 'مرئيات ضعيفة'] },
      { key: 'recommendation', label: 'التوصية النهائية', type: 'select', options: ['تؤخذ كأساس للقرار', 'تؤخذ كمدخل داعم', 'تؤخذ بحذر', 'لا يُعتمد عليها'] },
      { key: 'notes', label: 'ملاحظات', type: 'textarea', cols: 2 },
    ],
  },
  ...
  milestones: {
    ...
    formFields: [
      { key: 'initiativeId', label: 'المبادرة', required: true, type: 'reference', referenceEntity: 'initiatives' },
  ...
  tasks: {
    ...
    formFields: [
      ...
      { key: 'description', label: 'الوصف', type: 'textarea', cols: 2 },
      { key: 'initiativeId', label: 'المبادرة', type: 'reference', referenceEntity: 'initiatives' },
      { key: 'assigneeId', label: 'المسؤول', type: 'reference', referenceEntity: 'employees' },
      { key: 'priority', label: 'الأولوية', lookupCategory: 'Priority' },
  ...
  evaluations: {
    ...
    formFields: [
      { key: 'ideaId', label: 'الفكرة', type: 'reference', referenceEntity: 'ideas' },
      { key: 'expertId', label: 'الخبير', type: 'reference', referenceEntity: 'experts' },
      { key: 'leadEmployeeId', label: 'القائد', type: 'reference', referenceEntity: 'employees' },
  ...
  sponsorships: {
    ...
    formFields: [
      { key: 'partnerId', label: 'الشريك', required: true, type: 'reference', referenceEntity: 'partners' },
  ...
  'idea-expert-assignments': {
    ...
    formFields: [
      { key: 'ideaId', label: 'الفكرة', required: true, type: 'reference', referenceEntity: 'ideas' },
      { key: 'expertId', label: 'الخبير', required: true, type: 'reference', referenceEntity: 'experts' },
  ...
  'expert-challenge-assignments': {
    ...
    formFields: [
      { key: 'expertId', label: 'الخبير', required: true, type: 'reference', referenceEntity: 'experts' },
      { key: 'challengeId', label: 'الحملة', required: true, type: 'reference', referenceEntity: 'campaigns' },
  ...
  'campaign-business-challenges': {
    ...
    formFields: [
      { key: 'campaignId', label: 'الحملة', required: true, type: 'reference', referenceEntity: 'campaigns' },
      { key: 'businessChallengeId', label: 'تحدي الأعمال', required: true, type: 'reference', referenceEntity: 'business-challenges' },
    ],
  },
};
