...
export const ENTITY_CONFIGS: Record<string, EntityConfig> = {
  ...
  'sandbox-applications': {
    ...
    formFields: [
      ...
      { key: 'campaignId', label: 'الحملة المرتبطة', helperText: 'CHL-... الحملة التي قُدّم الحل ضمنها' },
      { key: 'businessChallengeId', label: 'تحدي الأعمال', helperText: 'BCH-... التحدي الذي يعالجه الحل' },
      { key: 'pilotId', label: 'التجربة الناتجة', helperText: 'PIL-... التجربة التشغيلية بعد القبول' },
      { key: 'ideaId', label: 'الفكرة المرتبطة', helperText: 'IDE-... إن نشأ الحل عن فكرة' },
      { key: 'partnerId', label: 'الجهة المسجّلة كشريك', helperText: 'PRT-... سجلّ الشريك' },
      { key: 'notes', label: 'ملاحظات', type: 'textarea', cols: 2 },
    ],
  },
